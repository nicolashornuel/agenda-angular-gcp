...
import { CanvasService, PAD_MAX, PadControlable, PadParam, Position } from 'app/musique/services/canvas.service';
...
export class AudioNodeReverbComponent implements AfterViewInit, PadControlable {
  ...
  constructor(private gainService: AudioGainService, private canvasService: CanvasService) { }
