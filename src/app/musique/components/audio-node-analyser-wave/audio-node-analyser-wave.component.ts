...
@Component({
  selector: 'app-audio-node-analyser-wave',
  templateUrl: './audio-node-analyser-wave.component.html',
  styleUrls: ['./audio-node-analyser-wave.component.scss']
})
export class AudioNodeAnalyserWaveComponent implements AfterViewInit {
